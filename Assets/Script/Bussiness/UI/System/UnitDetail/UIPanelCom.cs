...
namespace GamePlay.Bussiness.UI
{
    public class UIPanelCom
    {
        ...
        public void RefreshHead(GameEntityType entityType, int entityId)
        {
            ...
            // 头像
            this._binder.img_head.sprite = GameResourceManager.Load<Sprite>(headUrl);
            // 名称
        ...
        public void Refersh(GameEntityType entityType, int entityId)
        {
            ...
            displayAttributes?.Foreach((attr, idx) =>
            {
                ...
                // 属性图标
                item.group_img_icon.sprite = GameResourceManager.Load<Sprite>(UIPathUtil.GetAttributeIcon(attr.type));
                // 属性值
            ...
            if (entityl is GameRoleEntity role)
            {
                ...
                role.skillCom.ForeachSkills((skill, idx) =>
                {
                    ...
                    skillItem.img_icon.sprite = GameResourceManager.Load<Sprite>(url);
                });
