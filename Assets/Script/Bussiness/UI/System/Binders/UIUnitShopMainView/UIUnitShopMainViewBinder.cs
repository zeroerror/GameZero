...
public class UIUnitShopMainViewBinder
{
    ...
    public UIUnitItemBinder unitGroup_unit1 => _unitGroup_unit1 ?? (_unitGroup_unit1 = new UIUnitItemBinder(GameObject.Find("unitGroup_unit1")));
    private UIUnitItemBinder _unitGroup_unit1;
    public UIUnitItemBinder unitGroup_unit2 => _unitGroup_unit2 ?? (_unitGroup_unit2 = new UIUnitItemBinder(GameObject.Find("unitGroup_unit2")));
    private UIUnitItemBinder _unitGroup_unit2;
    public UIUnitItemBinder unitGroup_unit3 => _unitGroup_unit3 ?? (_unitGroup_unit3 = new UIUnitItemBinder(GameObject.Find("unitGroup_unit3")));
    private UIUnitItemBinder _unitGroup_unit3;
    public UIUnitItemBinder unitGroup_unit4 => _unitGroup_unit4 ?? (_unitGroup_unit4 = new UIUnitItemBinder(GameObject.Find("unitGroup_unit4")));
    private UIUnitItemBinder _unitGroup_unit4;
    public UIUnitItemBinder unitGroup_unit5 => _unitGroup_unit5 ?? (_unitGroup_unit5 = new UIUnitItemBinder(GameObject.Find("unitGroup_unit5")));
    ...
    public GameObject btn_confirm_txt => _btn_confirm_txt ?? (_btn_confirm_txt = this.gameObject.transform.Find("btn_confirm_txt").gameObject);
    ...
    public GameObject btn_refresh_txt => _btn_refresh_txt ?? (_btn_refresh_txt = this.gameObject.transform.Find("btn_refresh_txt").gameObject);
