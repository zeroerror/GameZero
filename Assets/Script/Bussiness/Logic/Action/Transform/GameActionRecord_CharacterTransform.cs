...
{
    public struct GameActionRecord_CharacterTransform
    {
        ...
        /// <summary> 变身属性列表 </summary>
        public GameAttribute[] transAttributes;

        public GameActionRecord_CharacterTransform(
            int actionId,
