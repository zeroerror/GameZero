...
namespace Game.Core
{
    public class GameFSMCom
    {
        ...
        {
            // var { fromState, toState, Condition } = transition;
            // if (!_stateDict.ContainsKey(fromState) || !_stateDict.ContainsKey(toState))
            //     return;

            // var existingTransition = FindTransition(fromState, toState, Condition, byList);
            // if (existingTransition != null)
            // {
            //     existingTransition.Condition = Condition;
            // }
        }
